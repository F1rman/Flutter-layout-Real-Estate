...
class SliderCardStatic extends StatefulWidget {
  SliderCardStatic({
    Key? key,
    this.click,
  }) : super(key: key);
  ...
  @override
  State<SliderCardStatic> createState() => _SliderCardStaticState();
}

class _SliderCardStaticState extends State<SliderCardStatic> {
  var slideIndex = 0;
  getSize(entry) {
    var size = 6;
